...
import CoffeeBeanCluster from "@/components/coffee-bean-cluster"
...
export default function Home() {
  return (
    <div className="overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative flex min-h-[100vh] items-center justify-center overflow-hidden pb-12 md:pb-16 lg:pb-32">
        ...
        <div className="absolute top-1/3 right-1/4 w-64 md:w-96 h-64 md:h-96 rounded-full blur-3xl bg-purple-500/10 animate-blob animation-delay-4000 z-0"></div>
        ...
        <div className="absolute bottom-1/3 left-1/3 w-64 md:w-96 h-64 md:h-96 rounded-full blur-3xl bg-purple-500/10 animate-blob animation-delay-2000 z-0"></div>
        ...
        <div className="container relative z-10 mx-auto px-4 text-center sm:px-6 lg:px-8 max-w-5xl pt-16">
          <motion.div
          ...
          >
            ...
            >
              ...
              <motion.div
                className="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-emerald-500/20 via-purple-500/20 to-emerald-500/20 rounded-xl blur-xl opacity-70"
                animate={{
                  opacity: [0.5, 0.7, 0.5],
                  boxShadow: [
                    "0 0 15px 5px rgba(16, 185, 129, 0.2), 0 0 15px 5px rgba(147, 51, 234, 0.2)",
                    "0 0 20px 8px rgba(16, 185, 129, 0.3), 0 0 20px 8px rgba(147, 51, 234, 0.3)",
                    "0 0 15px 5px rgba(16, 185, 129, 0.2), 0 0 15px 5px rgba(147, 51, 234, 0.2)",
                  ],
                }}
                transition={{
              ...
              {/* Card content - improved with hover effects */}
              <motion.div
                className="relative web3-card-glow-border p-3 sm:p-4 md:p-6 lg:p-8 rounded-xl backdrop-blur-sm bg-black/45 mx-auto max-w-4xl"
                whileHover={{
                  scale: 1.02,
                  boxShadow: "0 0 25px 10px rgba(16, 185, 129, 0.3), 0 0 25px 10px rgba(147, 51, 234, 0.3)",
            ...
            <div className="mt-12 sm:mt-16 md:mt-24 pt-8 sm:pt-12 md:pt-16 relative">
              ...
              <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-12 xl:gap-24 px-2 sm:px-4 relative">
                ...
                {/* Coffee bean between first and second cube */}
                <div className="relative h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12">
                  <CoffeeBeanCluster position="center" className="top-1/2 -translate-y-1/2" />
                </div>
                ...
                {/* Coffee bean between second and third cube */}
                <div className="relative h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12">
                  <CoffeeBeanCluster position="center" className="top-1/2 -translate-y-1/2" />
                </div>
